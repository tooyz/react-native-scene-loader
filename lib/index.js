...
export default class SceneLoader extends React.Component{
    ...
    componentDidUpdate(prevProps){
        ...
        const toggleFn = this.props.visible?vis:invis;
        ...
        if ( this.props.animation && prevProps.animation ){
            if ( this.props.visible ){
                this.runAnimation(this.props.visible, prevProps.onInAnimationEnd);
                prevProps.onInAnimationStart();
                vis();
            } else {
                this.isOutAnimating = true;
                this.runAnimation(this.props.visible, () => {
                    this.isOutAnimating = false;
                    prevProps.onOutAnimationEnd();
                    invis();
                });
                prevProps.onOutAnimationStart();
            }
        } else {
            toggleFn();
        }
